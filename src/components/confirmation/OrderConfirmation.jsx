    ...
    >
      ...
      >
        ...
        {completedOrder.deliveryTime && (
          <div className="mt-3 inline-flex items-center gap-2 px-4 py-2 bg-naranja/10 border border-naranja/20 rounded-xl">
            ...
            <span className="text-sm text-negro">
              Hora de entrega: <span className="font-bold text-naranja">{completedOrder.deliveryTime}</span>
            </span>
          </div>
        )}
      </motion.div>
